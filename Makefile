...
texeditor: build/texture_editor

build/texture_editor: tools/texture_editor.cpp src/glad.c
	mkdir -p build
	$(CC) $(INCLUDES) $(CFLAGS) tools/texture_editor.cpp src/glad.c $(LIBS) -o build/texture_editor

clean:
	-rm -f build/main build/map_editor build/texture_editor
